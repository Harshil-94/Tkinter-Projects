...
headlabel = tk.Label(Tops, font=('lato black', 19, 'bold'), text="Hii their, I am your personal Currency Converter",bg='#e6e5e5', fg='black')
...
label1 = tk.Label(window, font=('lato black', 15, 'bold'), text="\t    From Currency  :  ", bg="#e6e5e5", fg="black")
label1.grid(row=3, column=0, sticky=W)
label1 = tk.Label(window, font=('lato black', 15, 'bold'), text="\t    To Currency  :  ", bg="#e6e5e5", fg="black")
label1.grid(row=4, column=0, sticky=W)
label1 = tk.Label(window, font=('lato black', 15, 'bold'), text="\t    Converted Amount  :  ", bg="#e6e5e5", fg="black")
...
FromCurrency_option = tk.OptionMenu(window, variable1, *CurrenyCode_list)
ToCurrency_option = tk.OptionMenu(window, variable2, *CurrenyCode_list)
...
Label_9 = Button(window, font=('arial', 15, 'bold'), text="   Convert  ", padx=2, pady=2, bg="light blue", fg="white",
                 command=RealTimeCurrencyConversion)
Label_9.grid(row=6, column=0)
Label_1 = Label(window, font=('lato black', 7, 'bold'), text="", padx=2, pady=2, bg="#e6e5e5", fg="black")
Label_1.grid(row=9, column=0, sticky=W)
Label_9 = Button(window, font=('arial', 15, 'bold'), text="   Clear All  ", padx=2, pady=2, bg="light blue", fg="white",
                 command=clear_all)
